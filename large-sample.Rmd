...
$$
\m{V}[\v{X}_i^T\eps_i]=\E{\left(\v{X}_i^T\eps_i\right)^T\v{X}_i^T\eps_i}=\E{\left(\v{X}^T\eps\right)^T\v{X}^T\eps}=\E{\v{X}^T\v{X}\eps^2}\stackrel{\text{def}}{=}\m{A}.
$$
...
=\mathcal{N}\left(0,\m{Q}_{\v{XX}}^{-1}\m{A}\m{Q}_{\v{XX}}^{-1}\right)
$$
