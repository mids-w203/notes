...
$$
e_i=Y_i-\v{X}_i\v{\beta}, \mbox{ and } 
\widehat{e}_i=Y_i-\widehat{Y}_i.
$$

:::{.theorem #olserror name="Least Squares Error"}
If \ $\widehat{\mathbb{Q}}_{\v{XX}}$ is non-singular, then  
1. $\sum\limits_{i=1}^n\v{X}_i\widehat{e}_i=\v{0}$  
2. $\sum\limits_{i=1}^n\widehat{e}_i=0$
:::

:::{.proof}
\begin{align}
\sum\limits_{i=1}^n\v{X}_i\widehat{e}_i 
&=\sum\limits_{i=1}^n\v{X}_i(Y_i-\widehat{Y}_i) \\
&=\sum\limits_{i=1}^n\v{X}_iY_i-\sum\limits_{i=1}^n\v{X}_i\widehat{Y}_i \\
&=\sum\limits_{i=1}^n\v{X}_iY_i-\sum\limits_{i=1}^n\v{X}_i\v{X}_i^T\v{\widehat{\beta}} \\
&=\widehat{Q}_{\v{X}Y}-\widehat{Q}_{\v{XX}}\v{\widehat{\beta}} \\
&=\widehat{Q}_{\v{X}Y}-\widehat{Q}_{\v{XX}}
\left( \widehat{Q}_{\v{XX}}^{-1} \widehat{Q}_{\v{X}Y} \right) \\
&=\v{0}
\end{align}
...
$$
\begin{aligned}
Y_1 &= \v{X_1}\v{\beta} + e_1 \\
Y_2 &= \v{X_2}\v{\beta} + e_2 \\
& \vdots \\
Y_n &= \v{X_1}\v{\beta} + e_n
\end{aligned}
$$
...
$$
\widehat{\v{e}}=\v{Y}-\m{X}\widehat{\v{\beta}}.
$$
As a consequence, we can write
$$
\m{X}^T\widehat{\v{e}}=\v{0}.
$$
